...
- **Purpose:** Customer details enriched with demographic and geographic data.
- **Columns:**
...
- **Purpose:** Description of the products and their attributes.
- **Columns:**
...
### 3. Fact Sales Details **gold.fact_sales**
